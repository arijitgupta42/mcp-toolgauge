/*
 * The JSON shape of a `mcp-toolgauge ci --json` report, mirrored from the Pydantic models in
 * mcp_toolgauge/model/. Two things about that JSON drive every optional here:
 *
