...
`physicalLocation`s in it. SARIF is built for tools that read files, and mcpcheckup reads a
...
from mcpcheckup.model import Finding, LintResult, Severity

SARIF_VERSION = "2.1.0"
SARIF_SCHEMA = "https://json.schemastore.org/sarif-2.1.0.json"
INFORMATION_URI = "https://github.com/arijitgupta42/mcpcheckup"
...
def _result(finding: Finding) -> dict[str, object]:
    return {
        ...
        "partialFingerprints": {"mcpCheckupFinding/v1": _fingerprint(finding)},
        "ruleId": finding.rule,
    }
