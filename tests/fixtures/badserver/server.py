...
This is mcp-doctor's demo villain. It is deliberately bad, but it is meant to look like a
...
Nothing here does real work. mcp-doctor never invokes a tool (read-only invariant), so
