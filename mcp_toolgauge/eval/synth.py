...
from mcp_toolgauge.eval.backend import Completion
...
from mcp_toolgauge.lint.text import content_bag, jaccard, meaningful_name_tokens
from mcp_toolgauge.model import CaseKind, EvalCase, ToolSpec
