...
`physicalLocation`s in it. SARIF is built for tools that read files, and mcp-toolgauge reads a
...
from mcp_toolgauge.model import Finding, LintResult, Severity

SARIF_VERSION = "2.1.0"
SARIF_SCHEMA = "https://json.schemastore.org/sarif-2.1.0.json"
INFORMATION_URI = "https://github.com/arijitgupta42/mcp-toolgauge"
...
def _result(finding: Finding) -> dict[str, object]:
    return {
        ...
        "partialFingerprints": {"mcpToolgaugeFinding/v1": _fingerprint(finding)},
        "ruleId": finding.rule,
    }
